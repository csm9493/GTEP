...
ffn_num_arr = [4,8,16,32,64] 
M_arr=[5000, 10000, 15000, 20000] 
prompt_token_num_arr = [3, 5, 10, 20, 30, 50]
...
def main():
    ...
    for rand_num in range(0, total_rand_num):
        ...
        prefix = "rand_num_{}_ep_{}_milestone_{}_lr_{}_lr_decay_{}_batch_{}_w_decay_{}_scheduler_{}_optimizer_{}_ffn_num_{}_M_{}_pt_num_{}".format(
                        rand_num,
                        ep,
                        milestone_num,
                        lr,
