...
alpha_arr=[0.01, 0.05, 0.1, 0.15, 0.2]
...
def main():
    ...
    for rand_num in range(0, total_rand_num):
        ...
        prefix = "rand_num_{}_ep_{}_milestone_{}_lr_{}_lr_decay_{}_batch_{}_w_decay_{}_scheduler_{}_optimizer_{}_ffn_num_{}_alpha_{}".format(
                        rand_num,
                        ep,
                        milestone_num,
                        lr,
