...
g_prompt_length_arr=[5, 10, 15, 20, 30] # L_g
length_arr = [5, 10, 15, 20, 30] # L_e
...
def main():
    ...
    for rand_num in range(0, total_rand_num):
        ...
        g_prompt_length = random.choice(g_prompt_length_arr)
        ...
        prefix = "rand_num_{}_ep_{}_milestone_{}_lr_{}_lr_decay_{}_batch_{}_w_decay_{}_scheduler_{}_optimizer_{}_size_{}_L_e_{}_L_g_{}_top_k_{}_lamb_{}".format(
                        rand_num,
                        ep,
                        milestone_num,
                        lr,
