    ...
    def _train(self, train_loader, test_loader, train_loader_for_protonet):
        ...
        if self._cur_task == 0:
            ...
            if self.args['optimizer'] == 'sgd':
                ...
                optimizer = optim.AdamW(self._network.parameters(), lr=self.lrate , weight_decay=self.weight_decay)
...
#                 optimizer = optim.AdamW(self._network.parameters(), lr=self.lrate, weight_decay=self.weight_decay)
            ...
            if self.args["scheduler"] == 'cosine':
                scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=self.args['epochs'], eta_min=self.min_lr)
