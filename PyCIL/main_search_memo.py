...
lambda_aux_arr = [0.5, 1, 1.5, 2, 3,]
examplar_batch_size_arr = [16, 32, 64, 128, 256]
...
def main():
    ...
    for rand_num in range(total_rand_num, total_rand_num+1):
        ...
        prefix = "rand_num_{}_ep_{}_milestone_{}_lr_{}_lr_decay_{}_batch_{}_w_decay_{}_scheduler_{}_lambda_aux_{}_examplar_bs_{}".format(
                        rand_num,
                        ep,
                        milestone_num,
                        lr,
